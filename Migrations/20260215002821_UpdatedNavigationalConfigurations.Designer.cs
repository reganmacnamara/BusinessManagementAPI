...
namespace InvoiceAutomationAPI.Migrations
{
    ...
    [Migration("20260215002821_UpdatedNavigationalConfigurations")]
    partial class UpdatedNavigationalConfigurations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MacsBusinessManagementAPI.Entities.TransactionAllocation", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("TransactionAllocationID"));

                    b.Property<long>("AllocatingID")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("AllocatingID");

                    b.HasIndex("RecievingID");
            ...
            modelBuilder.Entity("MacsBusinessManagementAPI.Entities.TransactionAllocation", b =>
                {
                    b.HasOne("MacsBusinessManagementAPI.Entities.Transaction", "AllocatingTransaction")
                        .WithMany()
                        .HasForeignKey("AllocatingID")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("MacsBusinessManagementAPI.Entities.Transaction", "RecievingTransaction")
                        .WithMany()
                        .HasForeignKey("RecievingID")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.Navigation("AllocatingTransaction");

                    b.Navigation("RecievingTransaction");
                });
